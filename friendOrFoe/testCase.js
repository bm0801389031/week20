describe("Basic tests",function(){
    ...
    let base=["Alex","Arnold","Bart","Boris","Bruce","Chris","Claire","Dick","Frank","James","JoJo","Kyle","Ivan","Lisa","Max","Nikola","Omar","Rachel","Ryan","Tim"];
    
    for (let i=0;i<40;i++){
      base.shuffle();
      friends=base.slice(0,randint(0,base.length-1));
      it("Testing for "+(friends.length>0 ? friends.join(", ") : "no friends"),function(){
